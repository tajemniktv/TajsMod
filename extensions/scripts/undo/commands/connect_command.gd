...
# ConnectCommand - Undoable command for connection creation
# Author: TajemnikTV
# ==============================================================================
...
func _get_resource_id(window_name: String, relative_path: String) -> String:
    ...
    # Fallback: if path is empty/invalid, try finding ANY resource (legacy behavior)
    # This shouldn't happen with new commands but good for safety
